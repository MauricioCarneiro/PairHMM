 ...
 * Date: 10/16/12
 */
public class NoDelPairHMM extends PairHMM {
...
//        dumpMatrices();
        ...
        return Math.log10( matchMetricArray[endI][endJ] + XMetricArray[endI][endJ] ) - SCALE_FACTOR_LOG10;
    }
    ...
    private void initializeConstants( final int haplotypeSize,
        ...
        matchMetricArray[1][1] = INITIAL_CONDITION;
