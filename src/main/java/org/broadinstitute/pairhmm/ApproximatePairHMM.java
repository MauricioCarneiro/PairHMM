 ...
 *
 *  -- caching constants
 *  -- approximate log10 sum calculation
...
public class ApproximatePairHMM extends PairHMM {

    double[][] constantMatrix = null; // The cache in the ApproximatePairHMM
    double[][] distanceMatrix = null; // The cache in the ApproximatePairHMM
