...
/**
 * Pair HMM for local alignment as described by Figure 4.3 in Durbin 1998 book.
 *
 * This implementation does not contain any optimizations, and should produce the 'truth' results for any dataset.
 * All other implementations are optimizations on top of this one.
 *
 * User: rpoplin
 * Date: 3/1/12
 */

public class StandardPairHMM extends PairHMM {
